...
def get_params():
    params = {
        'weight': 'E:/DeepLearning/yolo-utils/runs/detect/train2/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
...
if __name__ == '__main__':
    ...
    model('E:/DeepLearning/yolo-utils/YOLO_Format/images/test', 'heatmap_result')